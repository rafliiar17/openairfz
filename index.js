const sessionName = "rafliiarz";
const donet = "https://saweria.co/iamrfz";
const owner = ["6281802757484"];
const {
...
async function startHisoka() {
  ...
  client.ev.on("connection.update", async (update) => {
    ...
    if (connection === "close") {
      ...
      console.log(color("Donate for creator https://saweria.co/iamrfz", "yellow"));
